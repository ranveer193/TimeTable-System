      ...
      >
        ...
        >
          ...
          <div className="relative bg-gradient-to-br from-primary-600 via-primary-600 to-primary-700 px-8 pt-10 pb-8">
            ...
            <div className="relative text-center">
              ...
              <motion.div
                ...
                className="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-2xl mx-auto mb-5 flex items-center justify-center shadow-2xl border border-white/30"
              >
                <svg
          ...
          <div className="px-8 pt-8 pb-8">
            ...
            <motion.div
              variants={itemVariants}
              className="flex gap-2 mb-8 bg-slate-100 p-1.5 rounded-xl shadow-inner"
            >
              <button
                type="button"
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          required={!isLogin}
                          disabled={loading}
                          className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    disabled={loading}
                    className="w-full pl-12 pr-12 py-3.5 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-primary-500 to-primary-600 text-white font-semibold py-4 rounded-xl shadow-lg shadow-primary-500/30 hover:shadow-xl hover:shadow-primary-500/40 transition-all duration-200 mt-8 disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none relative overflow-hidden group"
              >
                {/* Shimmer effect */}
